    ...
    public class KyCongChiTiet_BUS
    {
		...
		public void phatSinhKyCongChiTiet(int macty, int thang, int nam)
		{
			...
			foreach (var item in lstNV)
			{
				...
				kycongchitiet.IDCongTy = item.IDCongTy;
				...
				kycongchitiet.NGAYCONG = Function_BUS.demSoNgayLamViecTrongThang(thang, nam);
				kycongchitiet.TONGNGAYCONG = Function_BUS.demSoNgayLamViecTrongThang(thang, nam);
