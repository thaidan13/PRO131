...
namespace QLNHANSU
{
    public partial class frmHoSoLienQuan : DevExpress.XtraEditors.XtraForm
    {
        QuanLyNhanSuEntities db = new QuanLyNhanSuEntities();
        public frmHoSoLienQuan()
        {
            InitializeComponent();
        }

        HoSoLienQuan_BUS _hstd;
        ...
        void Savedata()
        {
            tb_ChiTietHoSoLienQuan hstd = new tb_ChiTietHoSoLienQuan();
        ...
        private void frmHoSoLienQuan_Load(object sender, EventArgs e)
        {
            _hstd = new HoSoLienQuan_BUS();
