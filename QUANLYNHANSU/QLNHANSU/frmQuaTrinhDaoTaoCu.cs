...
namespace QLNHANSU
{
    public partial class frmQuaTrinhDaoTaoCu : DevExpress.XtraEditors.XtraForm
    {
        public frmQuaTrinhDaoTaoCu()
        {
            InitializeComponent();
        }

        QuaTrinhDaoTaoCu_BUS _dtc;
        public int _manv;
        public string _hoten;
        int _Id;

        private void frmQuaTrinhDaoTaoCu_Load(object sender, EventArgs e)
        {
            txtnhanvien.Text = _hoten;
            _dtc = new QuaTrinhDaoTaoCu_BUS();
            loaddata();
        }
        ...
        void Savedata()
        {
            tb_QuaTrinhDaoTaoCu dtc = new tb_QuaTrinhDaoTaoCu();
