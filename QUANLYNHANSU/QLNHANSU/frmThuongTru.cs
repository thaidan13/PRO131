...
namespace QLNHANSU
{
    public partial class frmThuongTru : DevExpress.XtraEditors.XtraForm
    {
        ...
        void loaddata(int mnv)
        {
            try
            {
                ...
                var item = db.tb_ThuongTru.Where(x => x.MaNV == manv).SingleOrDefault();
        ...
        void Savedata()
        {
            tb_ThuongTru tt = new tb_ThuongTru();
